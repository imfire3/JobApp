...
export async function GET() {
  ...
  return NextResponse.json({
    cv_analysis: {
      ...
      focuses: [
        "parsing_score (nullable)",
        "structure / impact / keyword / overall scores",
        "target_roles with evidence",
        "strengths / weaknesses with evidence_from_cv",
        "recommendations + information_to_confirm",
      ],
    },
    job_match: {
      ...
      focuses: [
        "match_score (nullable) + score_breakdown",
        "requirements_assessment (required vs preferred)",
        "demonstrated / transferable / not_evidenced",
        "keywords_matched / keywords_missing",
        "cv_improvements + cover_letter_angle",
      ],
    },
    cover_letter: {
      ...
      editable: false,
      focuses: [
        "personalized hook from job mission",
        "CV evidence only",
        "first months as adaptable approach",
        "job language (FR/EN)",
      ],
    },
