...
=======
    <div className="grid gap-4 rounded-xl border bg-card p-4 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8">
      ...
      <div className="flex flex-row flex-wrap items-stretch gap-3 xl:col-span-8">
        <div className="flex min-w-fit flex-1 items-center justify-between gap-3 rounded-lg border px-3 py-2">
